			...
			<div class="footer-holder">
				<div class="container">
					<div class="row">
						...
						<div class="col-xs-12 col-sm-6 col-md-3">
							<h3 class="text-uppercase">Nos Informations</h3>
						...
						<div class="col-xs-12 col-sm-6 col-md-3">
							<h3 class="text-uppercase">Nos horaires d'ouvertures</h3>
						...
						<div class="col-xs-12 col-sm-6 col-md-3">
							<h3 class="text-uppercase">Souscription</h3>
							<p>Inscrivez-vous à notre liste de diffusion pour recevoir les mises à jour dans votre boîte aux lettres électronique.</p>
